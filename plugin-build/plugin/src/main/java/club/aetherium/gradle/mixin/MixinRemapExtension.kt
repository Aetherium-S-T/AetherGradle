...
import club.aetherium.gradle.utils.DefaultMap
import club.aetherium.gradle.utils.FinalizeOnRead
import club.aetherium.gradle.utils.defaultedMapOf
...
import club.aetherium.gradle.mixin.jma.hard.JMAHard
import club.aetherium.gradle.mixin.jma.refmap.JMARefmap
import club.aetherium.gradle.mixin.jma.JarModAgentMetaData
import club.aetherium.gradle.mixin.mixin.OfficialMixinMetaData
import club.aetherium.gradle.mixin.mixin.hard.BaseMixinHard
import club.aetherium.gradle.mixin.mixin.hard.HardTargetRemappingClassVisitor
import club.aetherium.gradle.mixin.mixin.refmap.BaseMixinRefmap
...
class MixinRemapExtension(
    loggerLevel: LogLevel = LogLevel.DEBUG,
